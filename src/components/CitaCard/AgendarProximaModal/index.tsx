...
const AgendarProxima: React.FC<ReagendarModalProps> = ({ hideModal, consulta, ...props }) => {
  const { endHour, startHour, showDatepicker, onChangeEndHour, onChangeStartHour, dia, setDia, handleAgendarProxima } = useReagendar(consulta)
      ...
      <View>
        ...
        <View style={{ marginTop: 15 }}>
          <TouchableOpacity style={styles.botonReagendar} onPress={() => {
            ...
            <Text style={styles.botonReagendarText}>Agendar proxima cita</Text>
          </TouchableOpacity>
